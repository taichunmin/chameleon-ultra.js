...
/**
 * CRC32 lookup table, Generated from http://www.sunshine2k.de/coding/javascript/crc/crc_js.html
 *
 * Refs:
 * - https://github.com/alexgorbatchev/crc/blob/master/src/calculators/crc32.ts
 * - https://github.com/SheetJS/js-crc32/blob/master/crc32.mjs
 */
const CRC32_LOOKUP = new Int32Array([
...
export function crc32 (buf: Buffer, prev: number = 0): number {
  let crc = prev ^ -1
  for (const u8 of buf) crc = (crc >>> 8) ^ CRC32_LOOKUP[(crc ^ u8) & 0xFF]
  return crc ^ -1
}
